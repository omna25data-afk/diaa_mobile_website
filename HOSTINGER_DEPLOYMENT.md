...
| أمر التثبيت | `npm ci --legacy-peer-deps` |
...
> يستخدم هذا المسار `npm` بدل `pnpm` لتفادي قيود تنفيذ الملفات الثنائية التي ظهرت في بيئة البناء. يتضمن أمر البناء `npm rebuild esbuild` لتجديد ملف esbuild التنفيذي قبل تشغيل Vite.
